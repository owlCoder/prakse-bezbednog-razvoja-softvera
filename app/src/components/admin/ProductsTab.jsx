...
import { getProductsAdmin, deleteProductAdmin, getGenresAdmin, updateProductAdmin } from '../services/admin';
...
const ProductsTab = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                try {
                    const token = await currentUser.getIdToken();
                    const response = await getGenresAdmin(currentUser, token);
    ...
    const handleDeleteProductClick = async () => {
        ...
        try {
            const token = await currentUser.getIdToken();
            const response = await deleteProductAdmin(uidToDelete, sellerUidToDelete, currentUser, token);
    ...
    const saveDataEdit = async () => {
        ...
        try {
            ...
            const response = await updateProductAdmin(currentUser, editData, token);
