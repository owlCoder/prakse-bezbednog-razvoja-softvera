          ...
          {loading === false && currentUser ? (
            ...
            <div>
              ...
              <button
                ...
                className="w-full text-white bg-blue-700 hover:bg-blue-800 font-semibold rounded-lg px-4 py-3 mt-6"
              >
                Go Back to Homepage
              </button>
            </div>
            ...
            <form className="mt-6" onSubmit={handleFormSubmit}>
              ...
              <div>
                <button type="submit" className="flex flex-row items-center justify-center w-full text-white bg-blue-700 hover:bg-blue-800 font-semibold rounded-lg
                  ...
                  LOG IN  <AiOutlineLogin className="plus-icon inline ml-2 text-xl" />
                </button>
              </div>
