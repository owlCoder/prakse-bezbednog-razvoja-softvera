      ...
      <div className="flex flex-col md:flex-row h-screen items-center bg-white dark:bg-gray-900 text-slate-600 dark:text-slate-100">
        ...
        <div className="relative w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
          ...
          <div className="w-full h-100">
            ...
            {/* Content Title */}
            <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Log In</h1>
            ...
            <form className="mt-6" onSubmit={handleFormSubmit}>
              ...
              <div className="text-right mb-5">
                <a href="/forgot-password" className="text-sm font-semibold text-blue-500 hover:text-blue-700 focus:text-blue-700">Forgot Password?</a>
              </div>

              {/* Log In Button */}
              <div className="flex flex-row">
                <button type="submit" className="flex flex-row w-full block text-white bg-blue-700 hover:bg-blue-800 font-semibold rounded-lg
              ...
              <div
                ...
                <a href="/" className="text-gray-900 text-5xl -mt-3 -ml-1 font-normal" />
              </div>
