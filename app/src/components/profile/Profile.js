...
export default function Profile() {
    ...
    const getToken = useCallback(async () => {
      try {
        ...
        return token; // Return the token for use in the `useEffect`
      } catch (error) {
            ...
            <div className="col-span-full xl:col-auto">
                <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                    <div className="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                        <img className="mb-4 rounded-lg w-28 h-28 sm:mb-0 xl:mb-4 2xl:mb-0" src="" alt="" />
                        <div>
                            ...
                            <li className="py-4">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <div className="inline-flex items-center">
                                        <a href="/revoke" className="px-3 py-2 mb-3 mr-3 text-sm font-medium text-center text-gray-900 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-primary-300 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Revoke</a>
                                    </div>
                                </div>
                            </li>
